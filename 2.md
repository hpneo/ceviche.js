...
var SiteNotifier = (function() {
  ...
  return {
    ...
    publish: function(channelName, message) {
      if (channels[channelName] instanceof Array) {
...
SiteNotifier.publish('site_title:changed', { oldTitle: 'La Buena Espina', newTitle: 'Bienvenidos a La Buena Espina' });
