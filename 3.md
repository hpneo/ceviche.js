...
B. Disponible para todos los navegadores, excepto Internet Explorer:
...
Cuando un evento es lanzado, este pasa por 3 fases, en el siguiente orden: *Capture phase*, *Target phase* y *Bubbling phase*.
