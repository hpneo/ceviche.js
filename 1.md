...
```javascript
var App = {
  homeTitle: 'La Buena Espina'
};

App.homeTitle;
// "La Buena Espina"

App.homeTitle = 'Bienvenidos a La Buena Espina';
// "Bienvenidos a La Buena Espina"
```
B. Con corchetes:
```javascript
...
App[nombre] = 'Bienvenidos a La Buena Espina';
// "Bienvenidos a La Buena Espina"
```
...
#### `Object.create`
Esta es una tercera forma de crear un objeto, permitiendo además definir el *prototype* del mismo y de sus propiedades.

```javascript
var superString = Object.create(String.prototype, {
  internalValue: {
    value: '',
    writable: true,
    configurable: false
...
superString.internalValue = 'La Buena Espina';
superString.nolanize();
// "L A   B U E N A   E S P I N A"
```
...
Object.defineProperty(superString, 'internalValue', {
...
Crea o modifica propiedades para un objeto. En este caso el segundo parámetro

```javascript
var superString = {};

Object.defineProperties(superString, {
  internalValue: {
    writable: true,     // internalValue podrá cambiar de valor
...
Object.getPrototypeOf(superString);
// String {}

superString.internalValue = 'Hola';
// "Hola"
Object.getPrototypeOf(superString.internalValue);
...
```javascript
for (var i = 0; i < 5; i++) { // inicio del bucle; condición; expresión incremental
  console.log(i);
}
