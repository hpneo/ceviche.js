...
Mientras que, para el segundo paso, el futuro nodo padre debe ejecutar el método `appendChild`. Mientras que, para eliminarlo, es necesario que el nodo padre ejecute el método `removeChild`.
