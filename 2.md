...
Este patrón se utiliza para casos donde se requiera condicionar la ejecución de una o más de una acción a la ejecución de otra previamente. Por ejemplo, se tiene el módulo `titleBuilder` integrado con `SiteNotifier`:
