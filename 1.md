...
#### `Object.create`
Create objetos permitiendo definir el *prototype* del mismo, además de sus propiedades.

#### `Object.defineProperty`
Crea o modifica una propiedad en un objeto.

#### `Object.defineProperties`
Crea o modifica propiedades para un objeto.
...
#### `Object.seal`
Sella un objeto, negando la posibilidad del objeto de tener nuevas propiedades y de configurar sus propiedades.
...
#### `Object.isSealed`
Verifica si el objeto está sellado. Un objeto está sellado si no son extensibles (`Object.isExtensible` devolviendo `false`) y si ninguna de sus propiedades son configurables.
